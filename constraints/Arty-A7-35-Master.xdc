...
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { CLK48MHZ }]; #IO_L12N_T1_MRCC_14
create_clock -add -name sys_clk_pin -period 20.83 -waveform {0 5} [get_ports { CLK48MHZ }];
...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { dac_rl_clk }]; #IO_L7N_T1_D10_14 			Sch=ck_io[38]
